...
import lives_affected from "../assets/lives-affected.png";
import leadership from "../assets/leadership_and_democracy.png";
import trees_planted from "../assets/tree-plantation.png";
  ...
  useEffect(() => {
    ...
    function incrementCounter2() {
      if (parseInt(counter[1].innerHTML) < final_values[1]) {
        ...
        setTimeout(incrementCounter2, 150);
      }
    }
    function incrementCounter3() {
      if (parseInt(counter[2].innerHTML) < final_values[2]) {
        ...
        setTimeout(incrementCounter3, 150);
      }
    }
    function incrementCounter4() {
      if (parseInt(counter[3].innerHTML) < final_values[3]) {
        ...
        setTimeout(incrementCounter4, 125);
      }
    }
